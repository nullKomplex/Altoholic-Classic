...
local lootTable = {
	...
	[L["Abyssal Council"] .. " (" .. C_Map.GetMapInfo(947).name .. ")"] = {	--  "Silithus"
	...
	[L["Elemental Invasion"]] = {	
		[BB["Baron Charr"] .. " (" .. C_Map.GetMapInfo(947).name .. ")"] = {	18671, 19268, 18672 },	-- "Un'Goro Crater"
		[BB["Princess Tempestria"] .. " (" .. C_Map.GetMapInfo(947).name .. ")"] = { 18678, 19268, 21548, 18679 }, -- "Winterspring"
		[BB["Avalanchion"] .. " (" .. C_Map.GetMapInfo(947).name .. ")"] = { 18673, 19268, 18674 },	--  "Azshara"
		[BB["The Windreaver"] .. " (" .. C_Map.GetMapInfo(947).name .. ")"] = { 18676, 19268, 21548, 18677 }	-- "Silithus"
	},
	[L["Gurubashi Arena"]] = {	
	...
	-- ** Sets & PVP ***
	[C_Map.GetMapInfo(947).name] = {	-- "Alterac Valley"
	...
	[C_Map.GetMapInfo(947).name] = {	--  "Arathi Basin"
	...
	[C_Map.GetMapInfo(947).name] = {	--  "Warsong Gulch"
	...
	[format(L["Level %d Honor PVP"], 80)] = {	
		...
		-- "Wintergrasp"
		[C_Map.GetMapInfo(947).name] = { 43956, 44077, 44066, 44075, 44069, 44068, 44067, 44081, 44084, 44082,
		...
		-- "Grizzly Hills"
		[C_Map.GetMapInfo(947).name] = { 38354, 38355, 38353, 38358, 38359, 38357, 38356, 38360, 38365, 38366,
